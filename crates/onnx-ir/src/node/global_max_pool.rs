...
//! For a 4D input [N, C, H, W], output is [N, C, 1, 1].
//! For a 3D input [N, C, L], output is [N, C, 1].
...
mod tests {
    ...
    #[test]
    fn test_global_max_pool_type_inference_3d() {
    ...
    #[test]
    fn test_global_max_pool_type_inference_4d() {
        let mut node = TestNodeBuilder::new(NodeType::GlobalMaxPool, "test")
